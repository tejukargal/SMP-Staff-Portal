          ...
          <table className="text-xs border-collapse w-full" style={{ minWidth: 2144 }}>
            ...
            <thead className="sticky top-0 z-20">
              ...
              <tr className="border-b-2 border-gray-200">
                ...
                {/* Actions */}
                <th className={`${TH} sticky right-0 z-10 bg-gray-50/95 text-center border-l border-gray-200`} style={{ minWidth: 120 }}>Status / Action</th>
              </tr>
            </thead>
              ...
              {visibleRows.map((row, rowIdx) => {
                ...
                return (
                  <tr key={row.key}
                    ...
                    {/* Actions */}
                    <td className={`${TD} sticky right-0 z-10 text-center border-l border-gray-100`}
                      style={{ background: stickyBg, minWidth: 120 }}>
              ...
              return (
                <tfoot className="sticky bottom-0 z-10">
                  <tr className="bg-gray-50 border-t-2 border-gray-300 text-[11px]">
                    ...
                    <td className="px-2.5 py-2 text-gray-400" colSpan={6}>—</td>
                    <td className="sticky right-0 z-10 bg-gray-50 px-2.5 py-2 text-center text-gray-400 border-l border-gray-200"
                      style={{ minWidth: 120 }}>—</td>
                  </tr>
                </tfoot>
              );
            })()}
